...
async function GET(_req, ctx) {
    ...
    if (!baseUrl) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: false,
    ...
    if (!res.ok) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            message: t || "Backend fetch failed"
        }, {
            status: res.status
        });
    }
...
async function PATCH(req, ctx) {
    ...
    if (!res.ok) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            message: t || "Backend update failed"
        }, {
            status: res.status
        });
    }
    ...
    if (!isBackendOk(payload)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            message: backendError(payload)
        }, {
            status: 500
        });
    }
    // Some APIs return updated record in payload.data; some return just ok.
    const updated = payload?.data?.mydata?.[0] ?? payload?.data ?? payload?.order ?? null;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true,
        order: updated
    });
