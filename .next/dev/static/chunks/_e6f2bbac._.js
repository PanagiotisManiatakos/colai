...
function LoginPage() {
    ...
    async function onSubmit(e) {
        ...
        if (u.length < 2 || p.length < 2) {
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginFail"])("Invalid input"));
            return;
        }
        setLoading(true);
        try {
            ...
            if (!res.ok || !data?.ok) {
                ...
                setError(msg);
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginFail"])(msg));
                return;
            }
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginOk"])({
...
_s(LoginPage, "d9RjQrXnWEkS4iIkXjNpBrx4Xbw=", false, function() {
    return [
